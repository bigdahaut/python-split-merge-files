...
try:
    if len(sys.argv) == 2 and (sys.argv[1] == '--help' or sys.argv[1] == '-h'):
        print(Fore.GREEN + 'Use:./merge_files split-files-dir result-file')
        print(Fore.GREEN + 'Ex:./merge_files split_files fast-scalable-secure-hosting.pdf')
    elif len(sys.argv) == 3:
        ...
        print(Fore.RED + 'Use:./merge_files split-files-dir result-file')
        print(Fore.RED + 'Ex:./merge_files split_files fast-scalable-secure-hosting.pdf')
except Exception as e:
    print(Fore.RED + str(e))
