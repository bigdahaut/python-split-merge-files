...
try:
    if len(sys.argv) == 2 and (sys.argv[1] == '--help' or sys.argv[1] == '-h'):
        print(Fore.GREEN + 'Use:./split_file file-to-split target_dir chunksize')
        print(Fore.GREEN + 'Ex:./split_file /path/to/myapp.1.0.0.apk /path/to/split_files 20')
    elif len(sys.argv) == 4:
        ...
        print(Fore.RED + 'Use:./split_file file-to-split target_dir chunksize')
        print(Fore.RED + 'Ex:./split_file /path/to/myapp.1.0.0.apk /path/to/split_files 20')
except Exception as e:
    print(Fore.RED + str(e))
